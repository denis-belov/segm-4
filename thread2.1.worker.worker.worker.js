...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/babel-loader/lib/index.js?!./node_modules/@open-wc/webpack-import-meta-loader/webpack-import-meta-loader.js!./node_modules/conditional-compile-loader/index.js?!../../renderity/wasm-wrapper/src/threads/thread2/thread2.1.worker.js");
/******/ })
/************************************************************************/
/******/ ({
      ...
      var _testAtomics = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./test-atomic/src/test-atomic.worker.js */ "../../renderity/wasm-wrapper/src/test-atomic/src/test-atomic.worker.js"));
            case 2:
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/@open-wc/webpack-import-meta-loader/webpack-import-meta-loader.js!./node_modules/conditional-compile-loader/index.js?!../../renderity/wasm-wrapper/src/threads/thread2/thread2.1.worker.js":
/*!***********************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--5-0!./node_modules/@open-wc/webpack-import-meta-loader/webpack-import-meta-loader.js!./node_modules/conditional-compile-loader??ref--5-2!/Users/Denis/reps/renderity/wasm-wrapper/src/threads/thread2/thread2.1.worker.js ***!
  \***********************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
onmessage = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var data, _data$data, function_addr, thread_types_addr, thread_values_addr, _function, arg_types, args, any_value_size, i, type_name;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          data = _ref.data;
        ...
        case 4:
          ...
          arg_types = wasm.size_t(thread_types_addr, _function.length);
          args = new Array(_function.length);
          any_value_size = wasm.size_t(wasm.globals.__any_value_size)[0];
          for (i = 0; i < _function.length; ++i) {
            type_name = wasm.type_names[arg_types[i]];
            args[i] = wasm.mem[type_name].interp_thread(thread_values_addr + any_value_size * i)[0];
          }
          postMessage(_function.apply(void 0, args));
        case 10:
        case "end":
          return _context.stop();
      }
...
/******/ });
//# sourceMappingURL=thread2.1.worker.worker.worker.js.map